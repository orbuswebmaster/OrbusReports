pageextension 55105 ProdRoutingPageExt extends "Released Production Orders"
{
    layout
    {
        addafter("Source No.")
        ...
        modify("Source No.")
        {
            ...
            begin
                ...
                begin
                    ...
                    SalesInvoiceHeader.SetRange("Order No.", Rec."Source No.");
                ...
                if var1 > 0 then exit
                    ...
                    Message('No Sales Header or Sales Invoice Header record exists based on Source No: ' + Rec."Source No.");
            end;
        }
    }
    actions
        ...
        addafter("Pro&d. Order")
        {
            action(InternalReprint)
            {
                ...
                begin
                    ...
                    SalesHeader.SetRange("No.", Rec."Source No.");
                    if SalesHeader.FindFirst()then begin
                        InternalReprint.GetValues(SalesHeader."No.", SalesHeader."Sell-to Customer Name", SalesHeader."Shipment Date", SalesHeader."Shipping Agent Code", SalesHeader."Shipping Agent Service Code", Rec."No.", SalesHeader."Assigned User ID", Rec."Location Code");
                    ...
                    begin
                        ...
                        SalesinvoiceHeader.SetRange("Order No.", Rec."Source No.");
                        if SalesinvoiceHeader.FindFirst()then begin
                            InternalReprint.GetValues(SalesInvoiceHeader."Order No.", SalesInvoiceHeader."Sell-to Customer No.", SalesInvoiceHeader."Shipment Date", SalesInvoiceHeader."Shipping Agent Code", SalesInvoiceHeader."Shipping Agent Service Code 2", Rec."No.", SalesInvoiceHeader."Art Email", Rec."Location Code");
                            InternalReprint.RunModal();
                            var1:=1;
                        end;
                    end;
                    if var1 > 0 then exit
                        ...
                        Message('No Sales Header Record or Sales Invoice header record based on Production Order record: %1', Rec."No.");
                end;
            }
        }
    }
