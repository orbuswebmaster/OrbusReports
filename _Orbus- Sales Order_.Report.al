report 55102 "Orbus- Sales Order"
{
    RDLCLayout = './ReportLayouts/OrbusSalesOrdernew.rdl';
    Caption = 'Orbus- Sales Order';
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem(Header; "Sales Header")
        {
            ...
            column(DocumentDate; Format("Document Date", 0, '<Month>/<Day>/<Year4>'))
            {
            }
            ...
            column(Orbus_Promised_Delivery_Date; Format("Promised Delivery Date", 0, '<Month,2>/<Day,2>/<Year4>'))
            {
            }
            column(Orbus_SalesReceivablesTextValue; Orbus_SalesReceivablesTextValue)
            {
            }
            column(Orbus_Shipment_Date; Format("Shipment Date", 0, '<Month,2>/<Day,2>/<Year4>'))
            {
            }
            ...
            column(Orbus_FreightTerms; Orbus_FreightTerms)
            {
            }
            column(Orbus_ShippingAcctNo; Orbus_ShippingAcctNo)
            {
            }
            column(Quote_No_; "Quote No.")
            {
            }
            column(Orbus_SalespersonName; Orbus_SalespersonName)
            {
            }
            ...
            dataitem(Line; "Sales Line")
            {
                ...
                column(Orbus_OrderTotal; Format(Orbus_OrderTotal, 0, '$<Precision,2:2><Sign><Integer Thousand><Decimals>'))
                {
                }
    ...
    Orbus_SalespersonName: Text;
    Orbus_DiscountAmount: Text;
    ...
    begin
        ...
        Orbus_OrderTotal:=SalesLine."Line Amount";
        Orbus_DiscountAmount:=Format(SalesLine."Inv. Discount Amount", 0, '<Precision,2:2><Sign><Integer Thousand><Decimals>');
    end;
    ...
    local procedure GetSalesPersonName()
    var
        Salesperson: Record "Salesperson/Purchaser";
    begin
        Salesperson.Reset();
        Salesperson.SetRange(Code, Header."Salesperson Code");
        if Salesperson.FindFirst()then Orbus_SalespersonName:=Salesperson.Name;
    end;
