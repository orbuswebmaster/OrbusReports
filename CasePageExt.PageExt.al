pageextension 55159 CasePageExt extends "Case Card WSG"
{
            ...
            group(LoggingTheIssue)
            {
                ...
                field("Customer Complaint"; Rec."Customer Complaint")
                {
                    ...
                    begin
                        ...
                        if CustomerComplaint.FindFirst()then var1:=1
                        else
                ...
                field("Customer Expectation"; Rec."Customer Expectation")
                {
                    ...
                    begin
                        ...
                        if CustomerExpectation.FindFirst()then var1:=1
                        else
        ...
        addafter(Status)
        {
            field(Priority; Rec.Priority)
            {
                ...
                begin
                    ...
                    if Priority.FindFirst()then var1:=1
                    else
            ...
            field(OpenSalesHeader; OpenSalesHeader)
            {
                ...
                begin
                    ...
                    begin
                        ...
                        if SalesHeaderArchive.FindFirst()then Page.Run(Page::"Sales Order Archive", SalesHeaderArchive)
                        else
            ...
            field(OpenSalesInvoiceHeader; OpenSalesInvoiceHeader)
            {
                ...
                begin
                    ...
                    if SalesInvoiceHeader.FindFirst()then Page.Run(page::"Posted Sales Invoice", SalesInvoiceHeader)
                    else
        ...
        addafter("Assigned User ID")
        {
            ...
            field("CS Status"; Rec."CS Status")
            {
                ...
                begin
                    ...
                    if CSStaus.FindFirst()then var1:=1
                    else
        ...
        addafter("Reason Description")
        {
            ...
            field("Department Specification"; Rec."Department Specification")
            {
                ...
                begin
                    ...
                    if Page.RunModal(Page::CaseReasonDetailList, CaseReasonDetail) = Action::LookupOk then begin
                        ...
                        if Rec.Modify()then ModifyDepartmentSpecificationCaseLine()
                        else
                            Error('Record was not succesffuly mdofied. Please try again')end;
                end;
                trigger OnValidate()
                var
                    CaseReasonDetail: Record CaseReasonDetail;
            ...
            field("Responsible Owner"; Rec."Responsible Owner Current")
            {
                ...
                var
                    ...
                    var1: Integer;
                begin
                    if Rec."Responsible Owner Current" = '' then var1:=1
                    else
                    begin
                        User.Reset();
        ...
        addafter("Entity Name")
        {
            ...
            field("Sales Quote No."; Rec."Sales Quote No.")
            {
                ...
                begin
                    ...
                    if Salesheader.FindFirst()then var1:=1
                    else
                        Error('Data/Value in sales quote no table field has to be based on record in the Sales header table')end;
            }
                ...
                begin
                    if Rec."Lookup Type" = Rec."Lookup Type"::"Sales Order" then begin
                        ...
                        if SalesOrderListPage.RunModal() = Action::LookupOK then begin
                            ...
                            SalesRecordForCase.Reset();
                            if SalesRecordForCase.FindLast()then var1:=SalesRecordForCase."Entry No." + 1
                            else
                                var1:=1;
                            SalesRecordForCase.Init();
                            SalesRecordForCase."Entry No.":=var1;
            ...
            field("Location Code"; Rec."Location Code")
            {
                ...
                begin
                    ...
                    if Location.FindFirst()then begin
                        if Dialog.Confirm('Are you sure you want to modify data to: ' + Rec."Location Code" + ' ?', true)then var1:=1
                        else
                        begin
    ...
    var
    begin
        if Rec."Entity Name" = '' then MandatoryVarName:=true
        else
            MandatoryVarName:=false;
        if Rec."Contact Name" = '' then MandatoryVarContactName:=true
        else
        ...
        if Rec."Must Arrive Date" = 0D then MandatoryVarDescribeMustArriveDate:=true
        else
    ...
    begin
        ...
        if CaseLine.FindSet()then repeat if CaseLine."SalesPerson Code" <> Rec."SalesPerson Code" then begin
    ...
    begin
        CaseLine.Reset();
        CaseLine.SetRange("Case No.", Rec."No.");
        if CaseLine.FindSet()then repeat if CaseLine."Contact Name" <> Rec."Contact Name" then begin
    ...
    begin
        CaseLine.Reset();
        CaseLine.SetRange("Case No.", Rec."No.");
        if CaseLine.FindSet()then repeat if CaseLine."Assigned User ID" <> Rec."Assigned User ID" then begin
    ...
    begin
        CaseLine.Reset();
        CaseLine.SetRange("Case No.", Rec."No.");
        if CaseLine.FindSet()then repeat if CaseLine."Reason Code" <> Rec."Reason Code" then begin
                    CaseLine."Reason Code":=Rec."Reason Code";
                    if Caseline.Modify()then var1:=1
                    else
    ...
    begin
        CaseLine.Reset();
        CaseLine.SetRange("Case No.", Rec."No.");
        if CaseLine.FindSet()then repeat if CaseLine."Resolution No." <> Rec."Resolution No." then begin
    ...
    begin
        CaseLine.Reset();
        CaseLine.SetRange("Case No.", Rec."No.");
        if CaseLine.FindSet()then repeat if CaseLine."Resolution Code" <> Rec."Resolution Code" then begin
    ...
    begin
        CaseLine.Reset();
        CaseLine.SetRange("Case No.", Rec."No.");
        if CaseLine.FindSet()then repeat if CaseLine.Name <> Rec."Entity Name" then begin
    ...
    begin
        CaseLine.Reset();
        CaseLine.SetRange("Case No.", Rec."No.");
        if CaseLine.FindSet()then repeat if CaseLine."Location Code" <> Rec."Location Code" then begin
    ...
    begin
        CaseLine.Reset();
        CaseLine.SetRange("Case No.", Rec."No.");
        if CaseLine.FindSet()then repeat if CaseLine.Status <> Format(Rec.Status, 0, '<Text>')then begin
    ...
    begin
        CaseLine.Reset();
        CaseLine.SetRange("Case No.", Rec."No.");
        if CaseLine.FindSet()then repeat if CaseLine."Resolution Code" = Rec."Resolution Code" then exit
                else
                begin
                    CaseLine."Resolution Code":=Rec."Resolution Code";
                    CaseLine.Modify();
    ...
    begin
        ...
        if CaseLine.FindSet()then repeat if CaseLine."Department Specification" <> Rec."Department Specification" then begin
